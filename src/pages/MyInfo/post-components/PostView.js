                ...
                <CardBody>
                    {Object.keys(post).length > 0 ? (
                        <>
                            ...
                            <Typography color="gray" className="min-h-[50px]">
                                {post.description}
                            </Typography>
                            <div className="text-[10px] grid grid-cols-2 space-x-2 mb-2">
                                ...
                                <div className="flex-col space-y-2">
                                    <div className="flex  items-center border-2 rounded-md bg-gray-100 p-1">
                                        <span className="ml-2">
                                            Lầu: {post.phong.sttLau === 0 ? 'Trệt' : post.phong.sttLau}
                                        </span>
                                    </div>
                                    <div className="flex items-center border-2 rounded-md bg-gray-100 p-1">
                                    ...
                                    <div className="flex items-center border-2 rounded-md bg-gray-100 p-1">
                                        <span className="ml-2">Giá phòng: {handleSetCost(post.phong.giaPhong)}</span>
                                    </div>
                                </div>
                            </div>
